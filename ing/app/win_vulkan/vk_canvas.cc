...
void  CanvasApp::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
    ...
    // bind the second pipeline, with its vertex and indices
...
void CanvasApp::createGraphicsPipeline()
{
...
void CanvasApp::createGraphicsPipeline2()
{
    // std::cout << "Happy Pipeline!" << std::endl;
    auto vertShaderCode = readFile("E:/assets/shaders/canvas2/vert.spv");
    auto fragShaderCode = readFile("E:/assets/shaders/canvas2/frag.spv");
