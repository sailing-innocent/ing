...
void VkCommonApp::run() {
    mainLoop();
}

void VkCommonApp::terminate() {
    cleanup();
}

void VkCommonApp::initWindow()
{
    glfwInit();
...
bool VkCommonApp::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
std::vector<const char *> VkCommonApp::getRequiredExtensions()
{
...
void VkCommonApp::setupDebugMessenger()
{
...
void VkCommonApp::pickPhysicalDevice()
{
...
void VkCommonApp::createLogicalDevice()
{
...
void VkCommonApp::createSurface() {
    /*
...
QueueFamilyIndices VkCommonApp::findQueueFamilies(VkPhysicalDevice device) {
...
bool VkCommonApp::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
SwapChainSupportDetails VkCommonApp::querySwapChainSupport(VkPhysicalDevice device) {
...
bool VkCommonApp::isDeviceSuitable(VkPhysicalDevice device) {
    /*
...
VkSurfaceFormatKHR VkCommonApp::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR VkCommonApp::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
// of the window.
VkExtent2D VkCommonApp::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void VkCommonApp::createSwapChain()
{
...
void VkCommonApp::createImageViews()
{
...
VkShaderModule VkCommonApp::createShaderModule(const std::vector<char>& code) {
...
void VkCommonApp::createRenderPass() 
{
...
void VkCommonApp::createFramebuffers() 
{
...
void VkCommonApp::createCommandPool()
{
    QueueFamilyIndices indices = findQueueFamilies(mPhysicalDevice);
...
void VkCommonApp::createCommandBuffer()
{
...
void VkCommonApp::createSyncObjects() {
...
void VkCommonApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
uint32_t VkCommonApp::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void VkCommonApp::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
