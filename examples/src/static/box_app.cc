...
void BoxApp::Update(const tbTimer& tbt)
...
void BoxApp::Draw(const tbTimer& tbt)
{
...
void BoxApp::BuildShadersAndInputLayout()
{
	...
	mvsByteCode = d3dUtil::CompileShader(L"E:/assets/shaders/color.hlsl", nullptr, "VS", "vs_5_0");
	mpsByteCode = d3dUtil::CompileShader(L"E:/assets/shaders/color.hlsl", nullptr, "PS", "ps_5_0");
